        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              <h3>DATA ANALYSIS</h3>
              <h4>Deriving Actionable Insights</h4>
              <p>
                Transforming raw datasets into clear, interactive dashboards and
                reports. From EDA to visualization, I make data simple and
                decision-ready.
              </p>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                Designing ML models and automated systems — from Random Forest
                classifiers to anomaly detection and NLP sentiment analysis —
